...
Note that the converter is being actively developed on the [Infinite Chess Repository](https://github.com/Infinite-Chess/infinitechess.org) nowadays and will no longer be updated on this repository.
